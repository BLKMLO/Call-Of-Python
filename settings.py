    ...
    def load(self):
        ...
        try:
            ...
            for action, fallback in DEFAULT_KEYS.items():
                ...
                RecursionError):
            # Premier lancement ou fichier invalide : valeurs par défaut.
            # RecursionError : un JSON sous 64 KiB peut dépasser la limite
            # de récursion de l'interpréteur (imbrication très profonde).
            pass
