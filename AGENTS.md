# AGENTS.md — Contexte projet Call of Python

> Synthèse de `CLAUDE.md` et `GPT.md` (dernière source : 23 juillet 2026),
> destinée aux agents IA qui lisent `AGENTS.md` (ex. Kimi Code). Les fichiers
> d'origine restent la référence détaillée.
